 ...
 * 资金形态
 */
class M_balance_payments extends CI_Model {

    const BALANCE_PAYMENTS = 'rbac_balance_payments';
    public function __construct() {
        parent::__construct();
    }
    public function update($conditions, $data) {
        $this->db->where($conditions);
        return $this->db->update(self::BALANCE_PAYMENTS, $data);
    }

    public function insert($data) {
        $this->db->insert(self::BALANCE_PAYMENTS, $data);
        return $this->db->insert_id();
    }
    public function delete($conditions){
        $this->db->where($conditions);
        return $this->db->delete(self::BALANCE_PAYMENTS);
    }
